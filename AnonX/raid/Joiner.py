...
ASSIDS = []
from AnonX.raid.main import bot as app
from AnonX.raid.assistant import get_assistant_details
from AnonX.raid.main import random_assistant 
from AnonX.raid.assistant import getassistant, save_assistant
