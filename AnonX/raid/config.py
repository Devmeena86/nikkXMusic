...
OWNER_NAME = getenv("OWNER_NAME", "AFK")
OWNER_USERNAME = getenv("OWNER_USERNAME", "AFK_BABY")
ALIVE_NAME = getenv("ALIVE_NAME", "AFK")
BOT_USERNAME = getenv("BOT_USERNAME", "DEV_M_U_S_I_C_BOT")
OWNER_ID = getenv("OWNER_ID", "5505686163")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "MUSIC_ASSTAINT")
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "II_VNND_WORLD_II")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "NIDHI_NETWORKSl")
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME")
HEROKU_API_KEY = getenv("UPDATES_CHANNEL", "HEROKU_API_KEY")
SUDO_USERS = list(map(int, getenv("SUDO_USERS", "5505686163").split()))
