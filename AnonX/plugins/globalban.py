...
async def gbanuser(client, message: Message, _):
    ...
    await message.reply_sticker("CAACAgUAAxkBAANSZKbvu0NwnTTEOUnFGVwumldib68AAh8LAAJAvnFX5GTwLvX81K4vBA")
...
async def gungabn(client, message: Message, _):
    ...
    await message.reply_sticker("CAACAgUAAxkBAANVZKbv_o6CNcPzDFyycH3qU_7l2uMAAskFAAKiIsBW4lxakKSsBW8vBA")
    await message.reply_text(
